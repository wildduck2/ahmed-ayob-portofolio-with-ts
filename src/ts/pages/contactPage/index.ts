...
export const ContactPage = () => {
    if ( location.pathname === '/src/pages/contactPage/index.html' ) {
...
export const FormSubmit = () => {
    ...
    const submitThanks: HTMLDivElement | null = document.querySelector( '.thanks-card' )
    const submitBlur: HTMLDivElement | null = document.querySelector( '.contact-blur' )
    const submitThanksH1: HTMLHeadingElement | null = document.querySelector( '.submit-heading' )
    const closesubmitCard: HTMLButtonElement | null = document.querySelector( '.close' )
